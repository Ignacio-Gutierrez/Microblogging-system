...
describe('Blog Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 26836 }], { headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' } });
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.blogsParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
