...
describe('Authority e2e test', () => {
  ...
  let username: string;
  let password: string;
  const authoritySample = { name: 'af9ad866-54f0-4553-b01c-1ff9f7444318' };
  ...
  describe('Authority page', () => {
    it('should have translated page title', () => {
      ...
      cy.getEntityHeading('Authority').should('not.contain', 'blogApp.adminAuthority.home.title');
    });
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('05555468-62cd-40c8-b9a3-18442ea30ba6');
      cy.get(`[data-cy="name"]`).should('have.value', '05555468-62cd-40c8-b9a3-18442ea30ba6');
